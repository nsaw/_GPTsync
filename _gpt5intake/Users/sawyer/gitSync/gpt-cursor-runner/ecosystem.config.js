module.exports = {
  apps: [
    ...
    {
      name: "ghost-bridge",
      script: "/Users/sawyer/gitSync/gpt-cursor-runner/scripts/core/ghost-bridge.js",
      watch: false,
      env: {
        NODE_ENV: "production",
    ...
    // Keep the unified manager watchdog persistent under PM2
    {
      ...
      script: "/Users/sawyer/gitSync/gpt-cursor-runner/scripts/watchdogs/unified-manager-watchdog.sh",
      interpreter: "bash",
      args: ["monitor"],
      watch: false,
      env: {
